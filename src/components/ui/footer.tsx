    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-4 order-1 lg:order-none">
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <div className="text-sm text-slate-300">© buzzflask.com <span className="text-slate-500">-</span> All rights reserved.</div>
              </div>
              {/* Social links */}
              <ul className="flex">
                <li>
                  <a className="flex justify-center items-center text-green-500 hover:text-green-400 transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-green-500 hover:text-green-400 transition duration-150 ease-in-out" href="#0" aria-label="Dev.to">
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-green-500 hover:text-green-400 transition duration-150 ease-in-out" href="#0" aria-label="Github">
                    <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* 3rd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-50 font-medium mb-2">BuzzFlask</h6>
            <ul className="text-sm space-y-2">
              <li>
