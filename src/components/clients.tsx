...
export default function Clients() {
  ...
  return (
    <section>
      <h2
        className="h2 pt-16 text-center bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4"
        data-aos="fade-down"
      >
        Plug and Play: Integrate Anywhere
      </h2>
